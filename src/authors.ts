...
export const AUTHORS: Author[] = [
  {
    ...
    events: [
      ...
      { year: 1961, yearEnd: 1967, place: 'Mexico City', country: 'Mexico', lng: -99.1332, lat: 19.4326, type: 'wrote', note: loc('Wrote One Hundred Years of Solitude here in 18 months (1965–1966)', 'Y écrivit Cent Ans de solitude en 18 mois (1965–1966)', '在此用十八个月写就《百年孤独》（1965—1966）') },
  ...
  },
  {
    ...
    events: [
      ...
      { year: 1831, place: 'Paris', country: 'France', lng: 2.3522, lat: 48.8566, type: 'wrote', note: loc('Published The Hunchback of Notre-Dame', 'Publia Notre-Dame de Paris', '出版《巴黎圣母院》') },
      ...
      { year: 1855, yearEnd: 1870, place: 'Guernsey', country: 'UK', lng: -2.5350, lat: 49.4660, type: 'wrote', note: loc('Hauteville House — completed Les Misérables (published 1862)', 'Hauteville House — acheva Les Misérables (publié en 1862)', '在高城居完成《悲惨世界》（1862年出版）') },
  ...
  },
  {
    ...
    events: [
      ...
      { year: 1947, yearEnd: 1949, place: 'Jura', country: 'UK', lng: -5.8000, lat: 55.9500, type: 'wrote', note: loc('Remote farmhouse on the Isle of Jura — wrote Nineteen Eighty-Four in worsening health', 'Ferme isolée sur l\'île de Jura — écrivit 1984 alors que sa santé déclinait', '在朱拉岛偏僻的农舍里，于每况愈下的病体中写下《一九八四》') },
  ...
  },
  {
    ...
    events: [
      ...
      { year: 1984, place: 'Shepperton', country: 'UK', lng: -0.5110, lat: 51.3950, type: 'wrote', note: loc('Published Empire of the Sun; shortlisted for the Booker Prize', 'Publia L\'Empire du soleil ; finaliste du Booker Prize', '出版《太阳帝国》，入围布克奖短名单') },
  ...
  },
  {
    ...
    events: [
      ...
      { year: 2003, place: 'San Jose', country: 'USA', lng: -121.8863, lat: 37.3382, type: 'wrote', note: loc('Published The Kite Runner — his debut novel became a global phenomenon', 'Publia Les Cerfs-volants de Kaboul — son premier roman devint un phénomène mondial', '出版《追风筝的人》，这部处女作风靡全球') },
      { year: 2007, place: 'San Jose', country: 'USA', lng: -121.8863, lat: 37.3382, type: 'wrote', note: loc('Published A Thousand Splendid Suns', 'Publia Mille soleils splendides', '出版《灿烂千阳》') },
    ],
  },
  {
    id: 'kazuo-ishiguro',
    ...
    events: [
      ...
      { year: 1987, yearEnd: 1989, place: 'London', country: 'UK', lng: -0.1276, lat: 51.5074, type: 'wrote', note: loc('Wrote The Remains of the Day, which won the Booker Prize in 1989', 'Écrivit Les Vestiges du jour, qui remporta le Booker Prize en 1989', '写就《长日将尽》，于1989年荣获布克奖') },
  ...
  },
  {
    ...
    events: [
      ...
      { year: 1924, yearEnd: 1926, place: 'Paris', country: 'France', lng: 2.3522, lat: 48.8566, type: 'wrote', note: loc('Part of the Lost Generation on the Left Bank; wrote The Great Gatsby (published 1925)', 'Membre de la Génération perdue sur la Rive gauche ; écrivit Gatsby le Magnifique (publié en 1925)', '身处左岸“迷惘的一代”，写下《了不起的盖茨比》（1925年出版）') },
